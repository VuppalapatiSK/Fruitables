...
const Footer = ()=> {
    return (
        <>
            <div className="container-fluid bg-dark text-white-50 footer pt-2 mt-5">
                <div style={{position: 'relative'}}    >
                    <Link to='/' className ='btn btn-outline-secondary btn-md-square rounded-circle' style={{position:'absolute', right: 0, top: 60}}>
                        ...
                        <div className="row g-4">
                            ...
                            <div className="col-lg-6">
                                <div className="position-relative mx-auto">
                                    <input className="form-control border-0 w-100 py-3 px-4 rounded-pill" type="ema" placeholder="Your Email" />
                            ...
                            <div className="col-lg-3">
                                <div className="d-flex justify-content-end pt-3">
                                    {socialIcon.map((icons, index) => (
                                        <a className="btn  btn-outline-secondary me-2 btn-md-square rounded-circle" href={icons.href} target={icons.target} key={index}>{icons.icon}</a>
                                    ))}
                                </div>
                            </div>
                        </div>
